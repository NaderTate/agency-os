...
**Included:** call handling, booking/reschedule/cancel, waitlist auto-fill, returning-client recognition, SMS confirmations/reminders, and a setup of your services, providers, and hours.

**Out of scope (for now):** payment collection, marketing campaigns, and EHR/charting integration. These can be added later.
...
*Example math (your numbers will differ):* if the receptionist saves just one $500 booking a week that would otherwise have gone to voicemail, that's ~$2,000/month recovered against a $500/month cost. One filled cancellation per week pays for itself several times over.

## Next step

A 20-minute discovery call to map your services, providers, and hours, and confirm the calendar setup. Book here and we'll get started.
