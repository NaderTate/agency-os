...
**Included:** 24/7 inbound intake + qualification, consult booking, outbound follow-up sequence, and intake-summary handoff. Configured to your practice areas and qualification rules.

**Out of scope (for now):** case-management system integration and e-signature. Addable later.

## Timeline

About 3 weeks: discovery + intake-script design (week 1), build + your review (week 2), go-live and tuning (week 3).

## Investment

- **Setup: $5,000** (one-time)
- **Monthly: $1,000/mo** (hosting, voice + AI usage, outbound follow-up, monitoring, and support)

*Example math (your numbers will differ):* if faster, 24/7 intake wins even one additional signed case per quarter, the value of that single case dwarfs a full year of the monthly fee.

## Next step

A 20-minute discovery call to capture your qualification criteria and intake flow. Book here.
