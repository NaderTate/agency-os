...
recording:                      # path to a meeting transcript (e.g. data/recordings/<slug>-kickoff-YYYY-MM-DD.md), /clickup will derive extra tasks from it
...
## Lead note (2026-05-27)

Raw blurb captured at intake goes here.
