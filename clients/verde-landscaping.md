...
deal_value:       2500
deal_mrr:         500
next_action:      Kick off the build (provision number, seed schedule, go live).
created:          2026-05-10
```

# Verde Landscaping

## Lead note (2026-05-10)

Residential landscaping + maintenance company. Owner Sofia is in the field all day; calls go to voicemail and she calls back at night, by which point half the leads booked someone else. Wants an AI receptionist that books estimates and routes urgent jobs.
